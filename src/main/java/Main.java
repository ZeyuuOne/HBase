...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        configuration.set("hbase.rootdir", "hdfs://h01:9000/hbase");
        connection = ConnectionFactory.createConnection(configuration);
        admin = connection.getAdmin();

        TableDescriptorBuilder tableDescriptorBuilder = TableDescriptorBuilder.newBuilder(TableName.valueOf("Students"));
